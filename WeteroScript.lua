--[[
    ...
    Author: @WeteroScript
    FIX: Waypoint beams between points + last WP to player
]]
...
local function createBeamBetweenParts(partA, partB, color)
    ...
    beam.Width0 = 0.3
    beam.Width1 = 0.3
    beam.Color = color or ColorSequence.new(Color3.fromRGB(0, 255, 255))
...
addBEBtn("📍 Create Waypoint", function()
    ...
    if #Features.Bot.Waypoints >= 2 then
        ...
        local beam = createBeamBetweenParts(prevPart, newPart, ColorSequence.new(Color3.fromRGB(0, 200, 255)))
        if beam then
            -- Store beam in the new waypoint for cleanup
            newWp.Beam = beam
            registerBeam(beam)
        end
    end
...
addBEBtn("🗑 Delete Last Point", function()
    ...
    for i = 2, #Features.Bot.Waypoints do
        local beam = createBeamBetweenParts(Features.Bot.Waypoints[i-1].Part, Features.Bot.Waypoints[i].Part, ColorSequence.new(Color3.fromRGB(0, 200, 255)))
        if beam then
