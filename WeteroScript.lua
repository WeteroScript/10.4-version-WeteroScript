--[[
    ...
    - Bot Speed/Jump меняются только после ON
    - Линии WP обновляются корректно
]]
...
-- ==================== TAB 5: BOT ====================
local botSpeedContainer, botSpeedInput = addToggleWithInput(page5, layout5, "Speed Val", "16", "16", function(e) end, function(v) end)
local botJumpContainer, botJumpInput = addToggleWithInput(page5, layout5, "Jump Val", "50", "50", function(e) end, function(v) end)

addToggle(page5, layout5, "Walk Speed", function(e)
...
addToggle(page5, layout5, "Jump Power", function(e)
    Features.Bot.JumpEnabled = e
    if e then
