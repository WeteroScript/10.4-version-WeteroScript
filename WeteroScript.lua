--[[
    WeteroScript v11.02 FINAL FIXED
    Author: @WeteroScript
    Исправления:
    - Start Mimic телепортирует к цели
    - Start Mimic показывает меню и кнопку
    - Start Bot: линия НЕ следует за персонажем
    - Stop Bot: линия следует за персонажем
    - Добавлен Jerk во вкладку Different
    - Open/Close Player List
    - Random Target с телепортом
    - Follow Offset/Delay с кнопками ON/OFF
]]
