--[[
    ...
    COMPATIBLE: Arceus X, Synapse, ScriptWare
]]
...
AdTitle.BackgroundTransparency = 1; AdTitle.Text = "WeteroScript v12.0"; AdTitle.TextColor3 = Color3.new(1, 1, 1)
...
Title.BackgroundTransparency = 1; Title.Text = "⚡ WeteroScript v12.0"; Title.TextColor3 = Color3.fromRGB(200, 200, 255)
...
local TAB_W = 96; local TAB_GAP = 3; local TabBtns = {}; local TabPages = {}
...
local function createTab(name, index)
    ...
    maxTabScroll = math.max(0, index * (TAB_W + TAB_GAP) - 500 + 10); updateTabScroll(); return page, layout
end
...
print("✅ WeteroScript v12.0 loaded! Compatible with Arceus X")
